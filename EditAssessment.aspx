<%@ Page Title="Edit Assessment" Language="C#" MasterPageFile="~/Dashboard.Master"
...
<div class="page-title">Edit Assessment</div>
<div class="page-subtitle">Update the assessment details while keeping the original question set intact.</div>
...
<div class="content-card">
    ...
    <div class="form-note">Change the title, description, or passing score.</div>
    ...
    <div class="form-group">
        ...
        <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" Rows="4" MaxLength="1000" />
    </div>
