namespace WAPP_Assignment_Module.Migrations
{
    ...
    public partial class AddModuleChapter : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        TopicTag = c.String(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Modules", "TrainerId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Chapters", "ModuleId", "dbo.Modules");
            ...
            DropIndex("dbo.Modules", new[] { "TrainerId" });
            DropIndex("dbo.Chapters", new[] { "ModuleId" });
