...
<div class="sidebar-section">
    <div class="sidebar-label">Attempt</div>
    <a href='<%= "AttemptAssessment.aspx?id=" + Request.QueryString["id"] %>' class="sidebar-item active"><span class="dot"></span> Current Assessment</a>
</div>
</asp:Content>
