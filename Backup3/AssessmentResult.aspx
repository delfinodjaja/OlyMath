...
<div class="sidebar-section">
    <div class="sidebar-label">Result</div>
    <a href='<%= "AssessmentResult.aspx?attemptId=" + Request.QueryString["attemptId"] %>' class="sidebar-item active"><span class="dot"></span> Current Result</a>
</div>
</asp:Content>
