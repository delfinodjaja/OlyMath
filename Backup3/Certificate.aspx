...
<div class="sidebar-section">
    <div class="sidebar-label">Certificate</div>
    <a href='<%= "Certificate.aspx?attemptId=" + Request.QueryString["attemptId"] %>' class="sidebar-item active"><span class="dot"></span> Current Certificate</a>
</div>
</asp:Content>
